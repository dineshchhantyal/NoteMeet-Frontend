...
const features = [
  {
    ...
    description: "Effortlessly plan and organize your meetings with our intuitive scheduling tool."
  },
  {
    icon: Mic,
    title: "Automated Recording",
    description: "Never miss a detail with our automatic meeting recording feature."
  },
  {
    icon: FileText,
    title: "Intelligent Transcription",
    description: "Get accurate, searchable transcripts of your meetings in real-time."
  },
  {
    icon: ListTodo,
