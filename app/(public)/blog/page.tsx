...
export const metadata: Metadata = {
  title: 'Blog | NoteMeet',
  description: 'Stay up to date with the latest news, tips, and insights from the NoteMeet team.',
}
...
const blogPosts = [
  {
    ...
    date: "2023-06-15",
    excerpt: "Discover how to leverage NoteMeet's features to boost your team's virtual meeting efficiency.",
    slug: "5-ways-to-make-virtual-meetings-productive"
  },
  {
    title: "The Future of AI in Meeting Transcription",
    date: "2023-05-28",
    excerpt: "Explore how AI is revolutionizing meeting transcription and what's next on the horizon.",
    slug: "future-of-ai-in-meeting-transcription"
  },
  {
    title: "How NoteMeet Helped TechCorp Streamline Their Communication",
    date: "2023-05-10",
    excerpt: "Read about how TechCorp improved their meeting efficiency by 40% using NoteMeet.",
