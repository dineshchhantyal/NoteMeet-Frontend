...
export const metadata: Metadata = {
  ...
  description: 'Read the terms and conditions governing the use of NoteMeet services.',
}
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="mt-4 bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700">Address: 900 University Ave, Monroe, LA 71209</p>
            </div>
          </section>
        </div>
      </div>
