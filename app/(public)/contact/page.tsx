...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with the NoteMeet team for support, sales inquiries, or partnership opportunities.',
}
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div>
          ...
          <p className="mb-8">
            Have a question or want to learn more about NoteMeet? We&apos;re here to help. Fill out the form and we&apos;ll get back to you as soon as possible.
          </p>
